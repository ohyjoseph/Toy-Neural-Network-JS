  ...
  */
  constructor(in_nodes, hid_nodes, out_nodes) {
    if (in_nodes instanceof NeuralNetwork) {
      ...
      this.weights_ih = a.weights_ih.clone();
      this.weights_ho = a.weights_ho.clone();

      this.bias_h = a.bias_h.clone();
      this.bias_o = a.bias_o.clone();
    } else {
      ...
      this.bias_h = math.matrix(math.random([this.hidden_nodes]));
      this.bias_o = math.matrix(math.random([this.output_nodes]));
    }
